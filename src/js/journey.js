...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const locations = [
    ...
    // Future
    { name: "South Korea", coords: [37.5665, 126.9780], status: "Future Goal", type: "future" },
    ...
    { name: "Taipei", coords: [25.0330, 121.5654], status: "Future Goal", type: "future" },
    ...
    { name: "New York City", coords: [40.7128, -74.0060], status: "Future Goal", type: "future" },
    ...
    { name: "拉萨", coords: [29.6500, 91.1000], status: "Future Goal", type: "future" },
